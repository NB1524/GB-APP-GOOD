...
export const initialExercises: Omit<Exercise, 'id'>[] = [
  // Chest Exercises
  {
...
export const exercisesByMuscleGroup = initialExercises.reduce((acc, exercise) => {
  ...
  return acc;
}, {} as Record<string, typeof initialExercises>); 